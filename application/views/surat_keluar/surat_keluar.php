                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <a class="btn btn-warning btn-sm" href="<?php echo site_url("surat_keluar/edit/". $row->id_user); ?>"><i class="fa fa-edit"></i> Edit</a>
                                                    <a href="#" id="p" class=" btn btn-sm btn-danger" onclick="confirm_modal('<?php echo "surat_keluar/delete/".$row->id_user; ?>');"><i class="fa fa-trash-alt"></i> Hapus</a>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>
                                            <?php $no++; 
